...
},{"./..\\img\\pin.png":[["pin.f9d2ef1d.png","../img/pin.png"],"../img/pin.png"],"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"alerts.js":[function(require,module,exports) {
"use strict";
...
},{"../css/style.css":"../css/style.css"}],"login.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', 'Error logging out ! Please try again in a while');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWJhZDI0IiwiYSI6ImNsbDEzaGZvcDBxOHozcHFybmR3aWlva3QifQ.SqKcRBb-FHofleB00MZprg';
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(n, email, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
var updateElement = document.querySelector('.form-user-data');
var userPassForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');

if (updateElement) {
  updateElement.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (logoutElement) logoutElement.addEventListener('click', _login.logout);
...
if (userPassForm) {
  userPassForm.addEventListener('submit', function (e) {
    ...
    var newpassconfirm = document.getElementById('password-confirm').value;
